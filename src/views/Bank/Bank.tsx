...
const LPTokenHelpText: React.FC<{ bank: BankEntity }> = ({ bank }) => {
  ...
  if (bank.depositTokenName.startsWith("MSC-AVAX")) {
    pairName = 'MSC-AVAX pair';
    uniswapUrl = 'https://traderjoexyz.com/pool/AVAX/' + tombAddr;
  } else if (bank.depositTokenName.startsWith("MSHARE-AVAX")) {
    pairName = 'MSHARE-AVAX pair';
    uniswapUrl = 'https://traderjoexyz.com/pool/AVAX/' + tshareAddr;
  } else {
    pairName = "MSC-MSHARE pair";
