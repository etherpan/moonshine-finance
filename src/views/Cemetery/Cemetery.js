              ...
              <Box mt={5}>
                <div hidden={activeBanks.filter((bank) => bank.sectionInUI === 2).length === 0}>
                  ...
                  <Alert variant="filled" style={{background:'#00bcd4'}}>
                    {isStart ? 
                      <div>Pools are live now, Stake LPs to earn more MSHARE, No deposit fee</div> : 
                      <>
                        Pools starting at {mfrom.toUTCString()}, No deposit fee.<br/>
                        <div style={{display:'flex'}}>MSHARE reward pools start in: <ProgressCountdown base={moment().toDate()} hideBar={true} deadline={mfrom} description="End Pool" />.</div>
                      </>
                    }
                  </Alert>
                  ...
                  <Alert variant="filled" severity={isOver ? 'info' : 'success'} style={{background:'#00bcd4'}}>
                    {isOver ? 
                      ...
                      <>
                        ...
                        {/* <div>Please refer to <a target="_blank" href="https://msc-finance.gitbook.io/untitled/" rel="noopener noreferrer">documentation</a> docs to understand our protocol's fee model.</div> */}
                      </>
                    }
                  </Alert>
                  {/* <Alert variant="filled" severity="warning">
