...
const configurations: { [env: string]: Configuration } = {
  ...
  //     'MSC-AVAX-LP': ['0xbC3E75B872BC1a293002f915d0ABb7b66E89D91d', 18], // 
  //     'MSHARE-AVAX-LP': ['0xf92fdbde85fea68b6a549b98e50b6a54cff8b3f5', 18],
  //     'MSC-MSHARE-LP': ['0xd9B5f00d183df52D717046521152303129F088DD', 18],
  //   },
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  TombUsdtRewardPool: {
    name: 'Stake USDT, earn MSC',
    poolId: 1,
    sectionInUI: 0,
    contract: 'TombUsdtRewardPool',
  ...
  TombAvaxLPTShareRewardPool: {
    name: 'Earn MSHARE by MSC-AVAX LP',
    poolId: 0,
    sectionInUI: 2,
    contract: 'TombAvaxLPTShareRewardPool',
    depositTokenName: 'MSC-AVAX-LP',
    earnTokenName: 'MSHARE',
    multiplier: "100x",
    finished: false,
    starttime: 1648452600000,
    sort: 5,
    closedForStaking: false,
  },
  TshareAvaxLPTShareRewardPool: {
    name: 'Earn MSHARE by MSHARE-WAVAX LP',
    poolId: 1,
    sectionInUI: 2,
    contract: 'TshareAvaxLPTShareRewardPool',
    depositTokenName: 'MSHARE-AVAX-LP',
    earnTokenName: 'MSHARE',
    multiplier: "100x",
    finished: false,
    starttime: 1648452600000,
