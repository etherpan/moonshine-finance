...
contract MShare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("MoonShine Share", "MSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 MSC Share for initial pools deployment
    ...
    function setTreasuryFund(address _communityFund) external {
        require(msg.sender == communityFund, "!community");
        communityFund = _communityFund;
    }
