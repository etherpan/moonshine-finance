...
// File contracts/distribution/MShareRewardPool.sol
...
// Instead, the governance will call mSHARE distributeReward method and send reward to this pool at the beginning.
contract MShareRewardPool {
    ...
    uint256 public mSharePerSecond = 0.00382587 ether; // 59500 mshare / (180 days * 24h * 60min * 60s)
    ...
    // Safe mshare transfer function, just in case if rounding error causes pool to not have enough mSHAREs.
